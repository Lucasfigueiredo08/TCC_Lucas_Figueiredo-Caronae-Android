...
public class SearchRidesListFrag_ViewBinding implements Unbinder {
  private SearchRidesListFrag target;

  @UiThread
  public SearchRidesListFrag_ViewBinding(SearchRidesListFrag target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SearchRidesListFrag target = this.target;
