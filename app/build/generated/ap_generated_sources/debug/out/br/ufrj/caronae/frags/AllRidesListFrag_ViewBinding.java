...
public class AllRidesListFrag_ViewBinding implements Unbinder {
  private AllRidesListFrag target;

  @UiThread
  public AllRidesListFrag_ViewBinding(AllRidesListFrag target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AllRidesListFrag target = this.target;
