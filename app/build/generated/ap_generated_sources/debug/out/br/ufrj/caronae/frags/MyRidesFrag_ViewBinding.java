...
public class MyRidesFrag_ViewBinding implements Unbinder {
  private MyRidesFrag target;

  @UiThread
  public MyRidesFrag_ViewBinding(MyRidesFrag target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MyRidesFrag target = this.target;
